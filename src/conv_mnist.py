...
# This is the finished HW
# model.add(tf.keras.layers.Conv2D(16, (3, 3), activation='relu', kernel_initializer='he_uniform'))
...
# Alternate improvement method for Extra Credit?
model.add(tf.keras.layers.Conv2D(32, (3, 3), activation='selu', kernel_initializer='he_uniform'))
model.add(tf.keras.layers.Conv2D(64, (3, 3), activation='selu', kernel_initializer='he_uniform'))
